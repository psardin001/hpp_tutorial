...
def solve(q_start=None):
    """Plan, optimize and time the transfer from the starting arm pose."""
    ...
    # Pick the gear, insert it on the support, then release it.
    problem.setParameter("StatesPathFinder/maxDepth", 3)
